...
void URPGAttributeSet::OnRep_Energy(const FGameplayAttributeData& OldEnergy)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Energy, OldEnergy);
}

void URPGAttributeSet::OnRep_Hungry(const FGameplayAttributeData& OldHungry)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Hungry, OldHungry);
}

void URPGAttributeSet::OnRep_Fear(const FGameplayAttributeData& OldFear)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Fear, OldFear);
}

void URPGAttributeSet::OnRep_Fatigue(const FGameplayAttributeData& OldFatigue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Fatigue, OldFatigue);
}

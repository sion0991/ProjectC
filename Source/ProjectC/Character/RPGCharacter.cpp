...
void ARPGCharacter::AttackToTargetAsCaller(ARPGCharacter* Target, TSubclassOf<UGameplayEffect> GameplayEffectClass, FGameplayTag DataTag, float Value)
{
	UAbilitySystemComponent* TargetASC = Target->GetAbilitySystemComponent();
	if (TargetASC)
	{
...
URPGAttributeSet* ARPGCharacter::GetAttribute()
{
	return AttributeSet;
}

...
bool UDataFunctionLibrary::SaveArrayText(FString SaveDir, FString FileName, TArray<FString> SaveText, bool AllowOverWriting)
{
	SaveDir += "\\";
	SaveDir += FileName;
...
bool UDataFunctionLibrary::SaveDataTableToCSV(FString SaveDir, FString FileName, UDataTable* DataTable, bool AllowOverWriting)
{
    if (!DataTable) 
    { 
...
void UDataFunctionLibrary::LoadCSVToDataTable(FString LoadDir, FString FileName, UDataTable* DataTable)
{
	LoadDir += "\\";
	LoadDir += FileName;
...
void UDataFunctionLibrary::AddFormationRow(FName RowName, FST_Formation Row, UDataTable* DataTable)
{
	DataTable->AddRow(RowName, Row);
}

void UDataFunctionLibrary::ResetDataTable(UDataTable* DataTable)
{
	DataTable->EmptyTable();
}

UDataTable* UDataFunctionLibrary::GetItemTable()
{
...
//void UDataFunctionLibrary::GetAllRowAtDataTable(UDataTable* DataTable, TArray<T>& Rows)
//{
